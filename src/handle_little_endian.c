...
void						swap_section_64(struct section_64 *sect_64)
{
	...
	swap_endian((unsigned char*)&sect_64->reserved1,
		sizeof(sect_64->reserved1));
	swap_endian((unsigned char*)&sect_64->reserved2,
		sizeof(sect_64->reserved2));
	swap_endian((unsigned char*)&sect_64->reserved3,
		sizeof(sect_64->reserved3));
}
								...
								uint32_t offset, uint32_t i)
{
	...
	swap_endian((unsigned char*)&nlist[i].n_un.n_strx,
		sizeof(nlist[i].n_un.n_strx));
							...
							uint32_t offset, uint32_t i)
{
	...
	swap_endian((unsigned char*)&nlist_64[i].n_un.n_strx,
		sizeof(nlist_64[i].n_un.n_strx));
	swap_endian((unsigned char*)&nlist_64[i].n_type,
		sizeof(nlist_64[i].n_type));
	swap_endian((unsigned char*)&nlist_64[i].n_sect,
		sizeof(nlist_64[i].n_sect));
	swap_endian((unsigned char*)&nlist_64[i].n_desc,
		sizeof(nlist_64[i].n_desc));
	swap_endian((unsigned char*)&nlist_64[i].n_value,
		sizeof(nlist_64[i].n_value));
}
